        ...
        historia1 = {
            personagens : [
                ...
                personagen4 = {
                    ...
                    imagemDoPersonagem: "./img/personagens/tchau.png",
                },
                personagen4 = {
                    nomeDoPersonagem: "Camponês Richard",
        ...
        hitoria1 = {
            ...
            opcoes : [
                ...
                opcaoA0 = {
                    ...
                    respostas: [
                        resposta1 = {
                            resposta: "Não preciso contar muito mais coisas, você terá muito ver ao adentrar os muros desse reino, sem falar que o povo adora contar as histórias sobre tudo o que aconteceu; porque acabaria com a graça dessa aventura de curiosidade que você pode ter.",
                            link : "b1",// Linkado com B1
                        ...
                        resposta2 = {
                            resposta: "Você foi chamado pelo rei, para um assunto importante de estremo sigilo pelo que eu soube.",
                            link : "b2", // Linkado com B2
    ...
    function mensagemFunc(quem, nome, msg, img) {
        ...
        if(quem == "sistema"){
            ...
            console.log("entrada para mensagemFunc() invalida!");
        }
    };
    function saidaAnteriorFunc(saidaAnterior) {
        saidaHistoriaAnterior += saidaAnterior;
    }
        ...
        if(opcaoSelecionada == 1) {
            ...
            // if(mensagens[historiaSelecionada].opcoes[idDoLinkSelecionado].respostas.npc1 == null) {
                ...
                mensagemFunc(
                    "jogador",
                    nomeDoJogador,
                    mensagens[historiaSelecionada].opcoes[idDoLinkSelecionado].opcao1,
                    personagens[historiaSelecionada].personagens[0].imagemDoPersonagem
                );

                mensagemFunc(
                    "sistema",
                    personagens[historiaSelecionada].personagens[encontraPersonagem(mensagens[historiaSelecionada].opcoes[idDoLinkSelecionado].respostas[0].npc)].nomeDoPersonagem,
                    mensagens[historiaSelecionada].opcoes[idDoLinkSelecionado].respostas[0].resposta,
                    personagens[historiaSelecionada].personagens[encontraPersonagem(mensagens[historiaSelecionada].opcoes[idDoLinkSelecionado].respostas[0].npc)].imagemDoPersonagem
                );
